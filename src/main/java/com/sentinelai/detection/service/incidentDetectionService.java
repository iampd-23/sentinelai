...
public class incidentDetectionService {
        ...
        public void detectForService(
                ...
                boolean errorSpike = errorSpikeDetectionService.hasErrorSpike(
                                serviceName,
                                environment);
                ...
                boolean incidentAlreadyOpen = incidentRepository.existsByMonitoredServiceIdAndStatus(
                                serviceId,
                                incidentStatus.OPEN);
                ...
                List<logTelemetry> relatedLogs = incidentCorrelationService.findRelatedErrorLogs(
                                serviceName,
                                environment,
                                incidentDetectedAt);

                incidentEvidenceService.saveEvidence(
                                incident,
                                relatedLogs);
